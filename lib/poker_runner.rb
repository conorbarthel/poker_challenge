...
def start
  deals
  hand1 = player_1_hand(deals[0])
  ranks = rank_list(hand1)
  suits = suit_list(hand1)
  straight_flush(%w(6S 7S 8S 9S TS))
  straight_flush(%w(6S 7S 8S 9S TC))
  royal_flush(%w(TC JC QC KC AC))
  blank_of_a_kind(%w(TC TH TS 6C 8D))
end
